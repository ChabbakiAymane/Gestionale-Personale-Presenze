...
function tableCreate() {
    ...
    // Header
    let table = `<table class="table table-striped table-dark" id = "myTableMagaz" style="min-width:75% text-aling: center;">
        <thead>
            <tr>
    ...
    for(var i=0; i<arrayDatiMagazzinieri.length; i++){
        ...
        var mattinaM = arrayDatiMagazzinieri[i][MATTINAMAGAZZINIERE];
        var pomeriggioM = arrayDatiMagazzinieri[i][POMERIGGIOMAGAZZINIERE];
        var totaleM = arrayDatiMagazzinieri[i][TOTALEMAGAZZINIERE];
