...
function dismissDangerAlertCorriere(){
    document.getElementById("alertDangerCorriere").style = 'display: none';
}
function dismissSuccessAlertCorriere(){
    document.getElementById("alertSuccessCorriere").style = 'display: none';
}
function dismissWarningAlertCorriere(){
    document.getElementById("alertWarningCorriere").style = 'display: none';
}
...
function tableCreate() {
    ...
    //set header of table
    let table = `
        <table class="table table-striped table-dark table-hover" id = "myTable" style="min-width:75%; text-align:center;">
        <thead>
            <tr>
            <th scope="col">ID</th>
